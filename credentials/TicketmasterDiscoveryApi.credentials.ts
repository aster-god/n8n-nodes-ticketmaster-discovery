...
export class TicketmasterDiscoveryApi implements ICredentialType {
	name = 'N8nDevTicketmasterDiscoveryApi';

	displayName = 'ticketmaster-discovery API';

	icon: Icon = { light: 'file:../nodes/TicketmasterDiscovery/ticketmaster-discovery.svg', dark: 'file:../nodes/TicketmasterDiscovery/ticketmaster-discovery.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			name: 'url',
			type: 'string',
			default: '//www.ticketmaster.com/discovery/v2',
			required: true,
			placeholder: '//www.ticketmaster.com/discovery/v2',
			description: 'The base URL of your ticketmaster-discovery API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
